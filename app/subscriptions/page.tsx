...
const plans: {
...
}[] = [
  {
    ...
    title: "Free",
    price: "0 грн / міс",
    description: "Базовий доступ без абонемента",
    features: [
      "Перегляд інформації про тренування",
      "Запис на відкриті групові тренування",
      "Без прив'язки до тренерів",
    ],
  },
  {
    id: "plus",
    title: "Абонемент Плюс",
    price: "600 грн / міс",
    badge: "Популярний",
    description: "Доступ до тренажерів + групові тренування",
    features: [
      "Повний доступ до тренажерної зони",
      "Групові тренування з вибраними тренерами",
      "Більше балів за кожне тренування",
    ],
  },
  {
    id: "premium",
    title: "Преміум (Повний доступ)",
    price: "800 грн / міс",
    badge: "Максимум можливостей",
    description: "Все включено для максимальної прокачки",
    features: [
      "Повний доступ до залу та всіх тренувань",
      "Персональні тренування з будь-яким тренером",
      "Підвищений множник балів та пріоритетний запис",
    ],
  },
];
...
export default function SubscriptionsPage() {
  ...
  const handleSelectPlan = async (planId: PlanId) => {
    ...
    try {
      ...
      if (!res.ok) {
        setError(data?.error || "Не вдалося оновити абонемент");
        setSavingPlan(null);
        return;
      }

      // оновлюємо локального юзера + localStorage
      setUser(updated);
      ...
      <div className="flex-1">
        <section className="mx-auto max-w-5xl px-4 py-10">
          ...
          <p className="mt-2 text-center text-sm md:text-base text-slate-700">
            Обери формат, який підходить саме тобі. Поточний абонемент:{" "}
